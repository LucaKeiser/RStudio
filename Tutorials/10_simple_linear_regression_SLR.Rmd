...
# => ideal the line should be on the dotted line (average residual error for each level of the outcome variable should be 0)
...
# Correlation benckmarks:             R^2 benchmarks:
